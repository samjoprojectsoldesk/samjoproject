...
<div class="row">
	<div class="col-md-12">
		<form name="frm" method="post" action="/admin/maszipcreate.do" class="tourcreate" enctype="multipart/form-data">
			<div class="form-group">
				<label for="m_code">맛집코드</label> 
				<input type="text" class="form-control" id="m_code" name="m_code" placeholder="R000">
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<textarea class="form-control" id="m_content" name="m_content" rows="3"></textarea>
			</div>
			<div class='bottom'>
