		...
		<div class="container">
			<div class="slider-text-inner desc">
				<h2
					...
					class="heading-section">문화행사 목록</h2>
					<button type="button" class="btn btn-primary" onclick="location.href='/admin/tour/create.do'">등록</button>
			</div>
		</div>
	</div>
			...
			<div class="col-md-12 text-center project">
				<div class="grid-project">
					<table class="table table-hover">
						<thead>
							<tr>
								<th scope="col">문화행사 코드</th>
								<th scope="col">문화행사 이름</th>
								<th scope="col">작성일</th>
