				...
				<div class="container">
					...
					<div class="bottomMenu">
                     <div class="searchWrap">
                       <div class="search">
                        <form method="post" name="SearchForm" action="" target="_blank" onsubmit="return ">
                           ...
                           <input type="submit" value="검색" class="btn btn-secondary" style="font-weight: bold; font-family: Arial; width:100px;">
                        </form>
                     </div>
                     </div>
                     <ul class="weather">
